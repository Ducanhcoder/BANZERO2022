...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            stdout.write("\r "+Fore.MAGENTA+""+Fore.YELLOW +" Đang Tấn Công - " + str((until - datetime.datetime.now()).total_seconds()) + " ")
        else:
            stdout.flush()
            stdout.write("\r "+Fore.MAGENTA+"[*]"+Fore.GREEN+" Tấn Công Hoàn Tất !                                   \n")
            return
#ua
...
def help():
    ...
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"layer7   "+Fore.LIGHTMAGENTA_EX+"|"+Fore.LIGHTWHITE_EX+" Show Panel Layer7                    "+Fore.LIGHTMAGENTA_EX+"  ║\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"layer4   "+Fore.LIGHTMAGENTA_EX+"|"+Fore.LIGHTWHITE_EX+" Show Panel Layer4                   "+Fore.LIGHTMAGENTA_EX+"   ║\n")
    ...
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.LIGHTMAGENTA_EX+"|"+Fore.LIGHTWHITE_EX+" Exit Tools                     "+Fore.LIGHTMAGENTA_EX+"        ║\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"  Thanks  "+Fore.LIGHTMAGENTA_EX+"|"+Fore.LIGHTWHITE_EX+" Thanks for using my tools<3.          "+Fore.LIGHTMAGENTA_EX+"║\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def infoattack():
...
def title():
    ...
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"                                   ╔╗ ╔═╗╔╗╔╔═╗"+Fore.LIGHTMAGENTA_EX+"╔═╗╦═╗╔═╗  ╦\n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"                                   ╠╩╗╠═╣║║║╔═╝"+Fore.LIGHTMAGENTA_EX+"║╣ ╠╦╝║ ║  ║\n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"                                   ╚═╝╩ ╩╝╚╝╚═╝"+Fore.LIGHTMAGENTA_EX+"╚═╝╩╚═╚═╝  ╩\n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"     "+Fore.LIGHTMAGENTA_EX+"\n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"      "+Fore.LIGHTMAGENTA_EX+"\n")
    stdout.write("                   "+Fore.LIGHTYELLOW_EX  +"                                      Released  in 2022\n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"      ╚══╦═════════════════════════════════════"+Fore.LIGHTMAGENTA_EX  +"═══════════════════════════════════╦══╝                                                                         \n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"    ╔════╩═════════════════════════════════════"+Fore.LIGHTMAGENTA_EX  +"═══════════════════════════════════╩═══════╗ \n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"    "+Fore.LIGHTCYAN_EX+"                      Welcome To The Main S"+Fore.LIGHTMAGENTA_EX+"creen BANZERO-V1 Software "+Fore.LIGHTMAGENTA_EX+"                 \n")                                                                   
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"     "+Fore.LIGHTCYAN_EX+"                           Powerful Layer"+Fore.LIGHTMAGENTA_EX+" 4 / 7 Bypasses   "+Fore.LIGHTMAGENTA_EX+"                                                    \n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"    ╚══╦═══════════════════════════════════════"+Fore.LIGHTMAGENTA_EX  +"════════════════════════════════════════╦══╝                     \n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"       ╚═════╦═════════════════════════════════"+Fore.LIGHTMAGENTA_EX  +"════════════════════════════════╦═══════╝    \n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"                   -  -  -  -  -    "+Fore.LIGHTCYAN_EX+  " [Dev :LuuD"+Fore.LIGHTMAGENTA_EX+"inhDucAnh ]"+Fore.LIGHTMAGENTA_EX+"     -  -  -  -  -          \n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"             ╚═════╦═══════════════════════════"+Fore.LIGHTMAGENTA_EX+"═════════════════════════╦══════╝            \n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"                                        ZaLo : "+Fore.LIGHTMAGENTA_EX+"0794088568                         "+Fore.LIGHTMAGENTA_EX  +"                        \n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX+"        ╔═════════╩══════════════════════════════"+Fore.LIGHTMAGENTA_EX  +"════════════════════════╩═════════════╗                                \n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX +"        "+Fore.LIGHTCYAN_EX+"                           Powered By"+Fore.LIGHTMAGENTA_EX+"  BANZERO-V1 "+Fore.LIGHTMAGENTA_EX+"                                                                \n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX +"          "+Fore.LIGHTCYAN_EX+"    Copyright© 2022 By BANZERO-V1 -"+Fore.LIGHTMAGENTA_EX+"  No Copying And Editing Is Allowed  "+Fore.LIGHTMAGENTA_EX+"                      \n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX +"           "+Fore.LIGHTCYAN_EX+"               Type [ Open Panel ]"+Fore.LIGHTMAGENTA_EX+"  To Display Panel          "+Fore.LIGHTMAGENTA_EX+"                                 \n")
    stdout.write("                   "+Fore.LIGHTCYAN_EX  +"        ╚══════════════════════════════════════"+Fore.LIGHTMAGENTA_EX  +"════════════════════════════════════════╝   \n")
...
##############################################################################################
def command():
    stdout.write(Fore.LIGHTYELLOW_EX+""+Fore.LIGHTCYAN_EX+"[""BANZERO-V1"+Fore.LIGHTMAGENTA_EX+"."+Fore.LIGHTMAGENTA_EX+"DucAnh"+Fore.CYAN+"]"+Fore.LIGHTYELLOW_EX+"\n\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
    if command == "cls" or command == "clear":
        clear()
        title()
    elif command == "Open Panel " or command == "Open Panel":
        help()
    elif command == "credit":
        credit()        
...
##############################################################################################     
        ...
        stdout.write(Fore.MAGENTA+" :33 "+Fore.WHITE+"Error type 'Open Panel'To Display Panel!\n")  
##############################################################################################   
